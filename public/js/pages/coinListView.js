const listView = (coin) =>
  ...
  <div class="main">
    ...
    <div class="ends-in">
      <h6>Ends in</h6>
      <h5>${coin.blocks} blocks</h5>
    </div>
    <button class="btn-secondary details-btn ${
      coin.isDetailsVisible ? "shown" : ""
    }" data-id="${coin.id}">
      <img src="../images/svg/coins/expand.svg" alt="" />
    </button>
  </div>
  <div class="details" style="display:${
    coin.isDetailsVisible ? "flex" : "none"
  }">
    <div class="boxes">
      <div class="earned">
...
const listCakeView = (cake) =>
  `<li class="coin-item">
    <div class="main">
      ...
      <div class="apr">
        <h6>Locked APY</h6>
        <h5>Up to ${cake.lockedApy}% <span class="calculator"></span></h5>
      </div>
      <div class="ends-in">
        <h6>Total staked</h6>
        <h5>${cake.totalStaked} CAKE</h5>
      </div>
      <button class="btn-secondary details-btn ${
        cake.isDetailsVisible ? "shown" : ""
      }" data-id="${cake.id}">
        <img src="../images/svg/coins/expand.svg" alt="" />
      </button>
    </div>
    <div class="details" style="display:${
      cake.isDetailsVisible ? "flex" : "none"
    }">
      <div class="boxes">
        <div class="earned">
...
export default { listView, listCakeView };
